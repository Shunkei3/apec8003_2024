...
Can you find any (weekly/strictly) dominant strategy for each player? If so, is there any dominant equilibrium?

???
+ Let's see these concepts with an example of Prisoner's Dilemma.
+ Can you find any dominant strategy for each player? Let's do this together. Can you fid 
...
+ Can you find a strictly dominant strategy for each player? (Recall that strictly dominant strategy is the best strategy no matter what the opponent may play.)

+ Can you find a strictly dominated strategy?
...
+ Can you find any strictly dominant strategy for each player? (Recall that strictly dominant strategies is the best strategy no matter what the opponent may play.)

<span style="color:blue">No.</span>

+ Can you find any <span style="color:blue">strictly dominated strategy</span>?
...
Can you find any strictly dominated strategy?
...
.content-box-green[**Nash equilibrium vs Iterated strict dominance**]
