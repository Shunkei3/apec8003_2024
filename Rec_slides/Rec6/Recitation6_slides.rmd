...
???
+ Let me explain what the problems in the final exam look like. 
+ The main topics in this last half of the game theory class are static game of incomplete information and dynamic game of incomplete information.

+ Today is the last recitation for game theory class. There are lots of problems that I want to 

+ One thing that you might want to practice is that Dynamic Cournot duopoly. Like the problem you did in Problem 1 in Assignment 3. Suppose that, only firm 1 knows the true state of the market demand, and you might be asked whether firm 1 should reveal the market information to firm 2 or not. 
+ Dynamic Cournot game involving separating and pooling strategies are complicated and bothersome. It takes lots of time and makes you mentally exhausted. 
+ So I recommend that at least you take a look at similar problems before the exam. 
...
???
+ I remember that I was confused with this definition. 
...
???
+ Let's start with a separating equilibrium. Since, there is no equilibrium path, the intuitive criterion does not impose any restrictions on Player B's brief. 
+ The separating equilibrium automatically satisfies the Intuitive Criterion. 
...
???
+ If the game is played according to the equilibrium strategies, the information set following $R$ is off the equilibrium path. 
...
???
+ Are you guys familiar with this game of trees?
+ Yes, this is the same problem from problem 4 of Assignment 4, and you guys already solved part (a). So, today we gonna do part (b). 



+ I noticed that the exact same problem is on this week's assignment, but one thing that I want to highlight is that this is a very basic problem in solving dynamic game of incomplete information, so I want you to practice this kind of problem many times until you are able to smoothly solve it without any hesitation or confusion. 

+ I listed similar problems somewhere in this slide deck. So, please practice them. Okay?
...
<!-- ???
+ Next Thursday will be the final exam. 
+ I will make sure to solve this week's assignment by Monday, so come to my office hours on Monday if you have any questions 
+ Also, my office hour usually starts from 12pm but I'll be there from 11:30.  -->
